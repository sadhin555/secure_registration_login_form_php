...
$mail->Username = 'sadhin@rahatanwarhospital.com';    // SMTP username
$mail->Password = 'wait&&&&&seeSH64'; // SMTP password
$mail->SMTPSecure = 'tls';                  // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                          // TCP port to connect to
$mail->setFrom('sadhin@rahatanwarhospital.com','Sadhin Halder');
