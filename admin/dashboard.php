...
<html lang="en">
    <head>
        ...
        <meta name="description" content="User Registration & Login and User Management System With Admin Panel">
        <meta name="author" content="sadhin555">
...
?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body"><center>Total Registered Users 
                                        <span style="font-size:22px;"><br><?php echo $totalusers;?></span></div>
...
?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
                                    <div class="card-body"><center>Yesterday Registered Users 
                                        <span style="font-size:22px;"><br><?php echo $yesterdayregusers;?></span></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
...
?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-success text-white mb-4">
                                    <div class="card-body"><center>Last 7 Days Registered Users
                                        <span style="font-size:22px;"><br><?php echo $last7daysregusers;?></span></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
...
?>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-danger text-white mb-4">
                                    <div class="card-body"><center>30 Days Registered Users
                                        <span style="font-size:22px;"><br><?php echo $last30daysregusers;?></span></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
